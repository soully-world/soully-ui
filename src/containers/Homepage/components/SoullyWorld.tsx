      ...
      <UlWrap>
        ...
        <LiWrap mb="0">
          ...
          >
            ...
            Kriyan-Soully is a collection of 20 NFTs created by 0xLambert himself. these interesting Soullys have their own exclusive names, 
            lines and backstories, and more importantly they are also proof of interest in the SoullyWorld NFT series. 
          </SoullyWorldContextText>
          <SoullyWorldContextText mt={40}>
          By holding a Kriyan-Soully you can enjoy a portion of the profits SoullyWorld generates during the development of the project.
          (mint has not started yet, please follow Twitter/Discord for more information)
          </SoullyWorldContextText>
          <SoullyWorldContextText
            // className="animate animate__slow animate__animated"
            data-animate="animate__fadeInRight"
